...
if Length_Directory >0:
    ...
    if len(root.filename) >0:
        ...
        worksheet_Front.set_margins(0.3, 0.3, 1.6, 1.1)
        ...
        worksheet_Front.set_column('B:B', 28)
        worksheet_Front.set_column('C:C', 26)
        worksheet_Front.set_column('D:D', 21)
